...
class ServerUrl
{
    const BASE_URL                  = "http://149.28.236.116:8080/";
    //const BASE_URL                  = "http://34.226.194.189:8080/";
    ...
    const FORGET_PWD_TKN_VERIFY     =   self::SERVER_PATH.'PostChangePasswordRequest';
    ...
    const GET_USER_APPOINTMENTS        =   self::SERVER_PATH.'appointment/GetAppointments';
    ...
    const GET_APPOINTMENTS                      = self::SERVER_PATH."/appointment/GetAppointments";
    const GET_CALENDER                          = self::SERVER_PATH."/GetExpertCalender";
    const UPDATE_APPOINTMENT                    = self::SERVER_PATH."/PostExpertAvailability";
    const APPOINTMENT_REPLY                     = self::SERVER_PATH."/PostExpertAppointmentReply";
    const APPOINTMENT_DETAILS                   = self::SERVER_PATH."/GetAppointmentDetailsV2";
}
