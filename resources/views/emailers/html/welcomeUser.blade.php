            ...
            <tr>
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
                  <tr>
                    <td align="left" style="padding:50px 50px 50px 50px"><p style="color:#262626; font-size:24px; text-align:left; font-family: Verdana, Geneva, sans-serif"><strong>Welcome to Expert Connect</strong></p>
                      <p style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">
                Dear {{ isset($data->name)?$data->name:'' }},
                        <br><br>Welcome to Expert Connect!
                        <br><br>Thank you for registering and taking the first step toward tennis Excellence.
                        <br><br>Here at Expert Connect you will find a unique platform to learn from the greatest names in tennis, both via video call (coming soon) and through access to our comprehensive, in-depth video library.
                        <br><br>Please check out the many Expert profiles and sample instructional content on our website.
                        <br><br>Subscribe to the full video library for complete access to over 300 detailed videos created by Grand Slam Champions, Celebrity Coaches and renowned experts in performance-related disciplines.
                        
                        <br />
                      </p>
                      <p style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">
                        <br />Regards,
                        <br />Expert Connect team
                      </p></td>
                  </tr>
                </table>
